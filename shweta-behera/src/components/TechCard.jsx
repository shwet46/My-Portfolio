...
const TechCard = ({imgSrc, label, desc, classes}) => {
  return (
    <div className={'flex items-center gap-3 ring-2 ring-inset ring-zinc-50/10 rounded-2xl p-3 hover:bg-gray-800 hover:ring-indigo-900 transition-colors group' + classes}>
